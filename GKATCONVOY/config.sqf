...
GKCLimitConvoyType = true;									//If true, only one type of each convoy will be able to spawn at a time.  If false make sure GKCMaxConvoy is less than or equal too total convoys below
...
GKCPersistentVehicle = false;								//true makes vehicles persistent, false makes them not for codelock claim script.

/////////////////////////////////////////		
//DO NOT TOUCH//		
/////////////////////////////////////////
GKCMaxConvoy = 0;											//Do Not Touch, as this is defined below in GKC_ConvoySpawn -  Only edit if GKCLimitConvoyType is false
...
LGKCMarker = createMarker ["GKATConvoy",[30.5041,30679.8,0]];
LGKCMarker setMarkerType "loc_LetterG";
LGKCMarker setMarkerColor "ColorGreen";
LGKCMarker setMarkerText "Convoys Coded by Vanaheim Arma Gaming Servers";
